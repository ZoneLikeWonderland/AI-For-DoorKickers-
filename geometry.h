...
class IntPoint {
  public:
	...
	bool operator==(IntPoint a) { return a.x == x && a.y == y; }
};

// class IntPointHash {
// 	public:
// 	size_t operator()(IntPoint a) { return a.x * MAXN + a.y; }
// };
...
/* return the most far point that can be jumped to */
Point bestjump(int vcount, Point Pointset[], Point p, double v);
...
//) >= 0。 判断Q1Q2跨立P1P2的依据是：( Q1 - P1 ) × ( P2 - P1 ) * ( P2 - P1 ) × (
// Q2 - P1 ) >= 0。
